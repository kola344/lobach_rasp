...
replic_admin_menu = 'Админ панель'
...
admin_keyboard = ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text='/users_count'), KeyboardButton(text='/users_data')]], resize_keyboard=True)
